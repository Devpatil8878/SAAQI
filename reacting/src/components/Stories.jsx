...
import AddStories from './sub_components/AddStories'
import WatchStories from './sub_components/WatchStories'
...
function Stories() {
  ...
  return (
    <>
      <div className="story-class gradient-border m-10 glass-blur flex w-[70%] overflow-x-auto no-scrollbar rounded-xl min-h-24">
        <AddStories />

        {arr.map((elem, index)=>{
          return <WatchStories user={elem.username} image={elem.storyImage}/>
        })}
